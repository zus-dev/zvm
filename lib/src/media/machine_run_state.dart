...
class MachineRunState {
  ...
  /// the address of the [textbuffer]
  MachineRunState._forRead(ReadMode readMode, int time, Char routine,
  ...
  static MachineRunState createReadLine(
    ...
    return MachineRunState._forRead(
  ...
  /// [time] interrupt interval and interrupt [routine]
